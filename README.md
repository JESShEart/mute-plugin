...
This README and code were all generated by Grok (xAI).  I am a software engineer and could have done all of this myself, but I did this in my free time and I did not want to invest the effort for something like thisk, as it would have felt too much like work.  So the condition of the code could be gross, but I don't care.  I just dump it all into Grok and tell it to modify whatever I'm interesting in it doing.  It was a good practice for trying to code using an LLM as the method of writing the code.
